...
namespace PracticaTienda.Controllers
{
    public class ProductosController : Controller
    {
        ...
        public async Task<IActionResult> Create([Bind("ProductoId,Codigo,Nombre,Modelo,Descripcion,Precio,Imagen,CategoriaId,Stock,Marca,Estatus")] Producto producto)
        {
        //AL AGREGAR REFERENCIAS A LLAVES FORANEAS SE TUVO QUE REALIZAR ESTO
        ...
        [HttpPost]
        [ValidateAntiForgeryToken]
        public async Task<IActionResult> Edit(int id, [Bind("ProductoId,Codigo,Nombre,Modelo,Descripcion,Precio,Imagen,CategoriaId,Stock,Marca,Estatus")] Producto producto)
        {
